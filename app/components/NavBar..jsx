...
export const NavBar = () => {
  return (
        ...
        <ul className="flex items-center">
                ...
                <li className="bg-gray-900 text-white px-3 py-2 rounded-xl m-5 text-m hover:text-blue-400"><a href="https://drive.google.com/file/d/1_-V1RyZBmo0NR-TfStFlEBWd-0WZo7nH/view?usp=sharing" target="blank">Resume</a></li>
